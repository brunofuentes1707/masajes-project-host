            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div><h4 className="font-bold text-stone-800">Ubicación</h4><p className="text-gray-600">Punto Copec, Ruta 78</p></div>
                  </div>
                  <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div><h4 className="font-bold text-stone-800">Horario</h4><p className="text-gray-600">Festivos y Feriados: 12:00 - 21:00</p></div>
                  </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-stone-300">
                <li className="flex items-center"><MapPin className="mr-2 w-4 h-4" />Punto Copec, Ruta 78</li>
