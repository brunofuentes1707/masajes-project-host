...
services_data = [
    ...
    { "id": 3, "name": "Masaje Descontracturante", "duration": "Sesión completa", "price": "$15.000", "description": "Técnicas para liberar contracturas.", "note": None, "image": "https://images.pexels.com/photos/3757942/pexels-photo-3757942.jpeg" },
    { "id": 4, "name": "Masaje Relajante", "duration": "Sesión completa", "price": "$13.000", "description": "Movimientos suaves para calma profunda.", "note": None, "image": "https://images.pexels.com/photos/3865676/pexels-photo-3865676.jpeg" },
    { "id": 5, "name": "Masaje Drenaje Linfático", "duration": "Sesión completa", "price": "$13.000", "description": "Técnica para eliminar toxinas.", "note": None, "image": "https://images.pexels.com/photos/6663461/pexels-photo-6663461.jpeg" }
]
